...
╚══════╝╚╚═╝  ╚═╝   ╚═╝   ╚══════╝ ╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝
    ...
    console.print(f"[bold green]A U T O M A T I C - S A T S U M A - B Y - @ P E T R U K S T A R[/bold green]", justify="center")
    console.print("-" * 50, style="green", justify="center")
    for _ in range(3):
        console.print(f"[yellow]> Initializing{'.' * (_ % 4)}[/yellow]", justify="center", end="\r")
        time.sleep(0.3)
    console.print(" " * 50, end="\r")
    console.print(f"[green]+ Satsuma Program - CREATED BY PetrukStar[/green]", justify="center")
    console.print("-" * 50, style="green", justify="center")
